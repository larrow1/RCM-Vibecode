...
| 4 | Org Mapper | Visualize org structures, spans of control, headcount/labor costs, role duplication, findings linked to org units | 2026-04-02 | `docs/specs/org-mapper.md`, `docs/architecture/org-mapper.md`, `apps/org-mapper/` |
