...
export const APPS: AppInfo[] = [
  ...
  },
  {
    id: "progress-flow",
    name: "Progress Flow",
    tagline: "AI-powered assessment workflow creation and progress tracking",
    description:
      "Create and manage assessment progress workflows with AI assistance. Select from pre-built templates (Full Assessment, Financial Due Diligence, Operational Review) or let AI generate custom flows based on engagement context. Track task completion across phases with interactive boards. Monitor overall engagement progress with dashboards and timeline views.",
    category: "workflow",
    status: "live",
    port: 3005,
    path: "apps/progress-flow",
    icon: "⚡",
    features: [
      "AI-powered flow generation from templates",
      "3 assessment templates (Full, Financial DD, Operational)",
      "Interactive phase/task board with status tracking",
      "Progress dashboard with completion metrics",
      "Engagement-scoped workflow management",
